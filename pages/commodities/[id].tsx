...
function Page() {
    ...
    const targetCommodity = Object.values(ledgerContext.commodities).find(it => it.id === id);
    ...
    const {
        data: fetchedPrices,
    } = useSWR(`/ledgers/${ledgerContext.ledger_id}/commodities/${id}/prices`, get);
    ...
    const update = async () => {
        await api.updateCommodity(id, precision, prefix === "" ? null : prefix, postfix === "" ? null : postfix);
            ...
            <AuthenticationLayout>
                <div className="container">
                    ...
                    <div>
                        ...
                        <input type="number" value={precision} placeholder="name"
                               onChange={e => setPrecision(parseInt(e.target.value, 10))}/>
                        <input type="text" value={prefix} placeholder="name" onChange={e => setPrefix(e.target.value)}/>
                        <input type="text" value={postfix} placeholder="alias"
