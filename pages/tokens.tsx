    ...
    <AuthenticationLayout>
      <div className="container">
        ...
        {newToken && (
          <div>
            <p>
              please remember this token value, it would not be showed again.
            </p>
        ...
        <ControlGroup fill={false} vertical={false}>
          ...
          />
          <Button icon="small-plus" onClick={createNewToken}>
            Create
          </Button>
        </ControlGroup>
              ...
              {tokens.map((it) => (
                <tr key={it.id}>
                  ...
                  <td>
                    <Popover2
                      content={
                        <div key="text" style={{ padding: "1rem" }}>
