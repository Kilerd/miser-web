...
export default function Nav() {
  ...
  const elements = Object.values(ledgerContext.ledgers).map((ledger) => (
    <MenuItem
      active={ledger.id.toString() === ledgerContext.ledger_id}
      key={ledger.id}
      icon="bank-account"
      onClick={() => ledgerChange(ledger.id)}
      text={ledger.name}
    />
  ));
  ...
  return (
    <>
      <nav>
        <NewTransactionModal
          modalStatus={newTrxStatus}
          setModalStatus={setNewTrxStatus}
        />
        <div className="top">
            ...
            <Popover
              content={
                <Menu>
                  ...
                  <MenuDivider />
                  <Link href="/ledgers">
                    <MenuItem icon="log-out" text="Manage Ledgers" />
                  </Link>
                </Menu>
              }
          ...
          <div
            className={`nav-btn create-trx-btn`}
            onClick={(e) => setNewTrxStatus(true)}
          >
          ...
          <Link href="/dashboard">
            <div
              className={`nav-btn ${
                router.asPath.startsWith("/dashboard") ? "active" : ""
              }`}
            >
          ...
          <Link href="/journals">
            <div
              className={`nav-btn ${
                router.asPath.startsWith("/journals") ? "active" : ""
              }`}
            >
          ...
          <Link href="/accounts">
            <div
              className={`nav-btn ${
                router.asPath.startsWith("/accounts") ? "active" : ""
              }`}
            >
          ...
          <Link href="/commodities">
            <div
              className={`nav-btn ${
                router.asPath.startsWith("/commodities") ? "active" : ""
              }`}
            >
              <Icon className={`${Classes.MINIMAL} nav-btn`} icon="euro" />{" "}
              <p>Commodities</p>
            </div>
          </Link>
          <Link href="/schedulers">
            <div
              className={`nav-btn ${
                router.asPath.startsWith("/schedulers") ? "active" : ""
              }`}
            >
              <Icon className={`${Classes.MINIMAL} nav-btn`} icon="euro" />{" "}
              <p>Schedulers</p>
          ...
          <Link href="/budgets">
            <div
              className={`nav-btn ${
                router.asPath.startsWith("/budgets") ? "active" : ""
              }`}
            >
              <Icon className={`${Classes.MINIMAL} nav-btn`} icon="euro" />{" "}
              <p>Budgets</p>
