...
export default function NewCommodityModal({modalStatus, setModalStatus}) {
  ...
  return (
    ...
    >
      ...
      <div>
        precision:
        <input type="text" value={precision} placeholder="precision" onChange={e => setPrecision(e.target.value)}/>
      </div>
      <div>
        prefix:
        <input type="text" value={prefix} placeholder="prefix" onChange={e => setPrefix(e.target.value)}/>
      </div>
      <div>
        postfix:
        <input type="text" value={postfix} placeholder="postfix" onChange={e => setPostfix(e.target.value)}/>
      </div>
